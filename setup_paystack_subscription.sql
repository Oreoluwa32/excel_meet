-- Setup Paystack Subscription Tables and Functions
...
-- 2. Create indexes for subscription queries
...
DO $$
BEGIN
  RAISE NOTICE 'Paystack subscription setup completed successfully!';
  RAISE NOTICE 'Tables created: payment_history';
  RAISE NOTICE 'Columns added to user_profiles: subscription_tier, subscription_status, subscription_start_date, subscription_end_date, paystack_subscription_code';
  RAISE NOTICE 'Functions created: check_subscription_status, get_user_payment_history, update_expired_subscriptions';
END $$;